...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        # nome
        self.assertIn('Allan Lima', email.body)
        # cpf
        self.assertIn('45773653320', email.body)
        # email
        self.assertIn('arglbr@gmail.com', email.body)
        # fone
        self.assertIn('85-98872-8779', email.body)
